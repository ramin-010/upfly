...
import { summarise, withDefaults } from './invoice-expand-12.js';

describe('invoice-expand-12', () => {
  ...
  it('replays a draft subscriber without losing the rest', () => {
  ...
  it('merges a draft subscriber without losing the rest', () => {
